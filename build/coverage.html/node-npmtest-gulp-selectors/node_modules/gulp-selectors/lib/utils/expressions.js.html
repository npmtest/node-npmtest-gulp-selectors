...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gulp-selectors/node_modules/gulp-selectors/lib/utils/expressions.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gulp-selectors/node_modules/gulp-selectors/lib/utils/expressions.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gulp-selectors/node_modules/gulp-selectors/lib/utils/</a> &#187; expressions.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var selectorName = '(-?[_a-z]+[_\\w-]*)';
...
module.exports = {
	 ...
	 * @returns {RegExp}
	 */
	jsString: <span class="fstat-no" title="function not covered" >function(name) {</span>
<span class="cstat-no" title="statement not covered" >		return new RegExp('[\'|"]' + name + '[\'|"]', 'g');</span>
	}
};
&nbsp;
&nbsp;</pre></td></tr>
